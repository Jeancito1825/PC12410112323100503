...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    {
        ...
        {
            // Only configure the context here if no options have been provided by DI.
            optionsBuilder.UseSqlServer("Server=AO2300944;Database=TallerMecanico;Integrated Security=True;TrustServerCertificate=True");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Cliente__3214EC074E4CD810");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrdenSer__3214EC0712341534");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TipoServ__3214EC078A89B63F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vehiculo__3214EC072DE297BA");
